# coding: utf_8
"""LLMテスト（非ストリーミング・履歴なし） - ももちゃんシステムロール"""
...
# システムロール（ももちゃん）　ももちゃんのキャラクター設定と話し方のルールを定義しています。これに従ってLLMが回答します。
SYSTEM_ROLE = """# Role
...
if __name__ == "__main__":
    print("=" * 50)
    print("ももちゃん チャット（非ストリーミング・履歴なし）")
